...
const Navbar = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full p-4 bg-slate-950 border-b border-cyan-500/30 flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0 overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.5)]">
            ...
            <h1 className="text-2xl font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-emerald-400 drop-shadow-[0_0_8px_rgba(6,182,212,0.6)] text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-6 w-full sm:w-auto">
                ...
                <select 
                    ...
                    className="bg-slate-900 text-cyan-400 text-sm font-mono font-bold tracking-widest p-2 border border-cyan-500/50 focus:outline-none focus:border-cyan-300 focus:shadow-[0_0_10px_rgba(6,182,212,0.3)] cursor-pointer appearance-none px-4 rounded-none transition-all uppercase w-full sm:w-auto text-center"
                >
